<?php
 ...
 function search_user(){
    ...
    if(isset($_GET['search_btn'])){
        ...
        $get_user="select * from user where user_name like '%$search_query%' or user_country like '%$search_query%'";

    }else{
        $get_user="select * from user order by user_country,user_name DESC LIMIT 5";
